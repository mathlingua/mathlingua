...
{
  "text": "[\\transitive.relation:on{X}]\nDefines: <\nassuming: 'X is \\set'\nmeans:\n. '< is \\binary.operation:on{X}'\n. for: a, b, c\n  where: 'a, b, c \\in X'\n  then:\n  . if:\n    . 'a < b'\n    . 'b < c'\n    then:\n    . 'a < c'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["transitive", "relation", "on", "x", "<", "is", "set", "binary", "operation", "a", "b", "c", "in", "reference", "=", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[\\order.relation:on{F := (X, +, *, 0, 1)}]\nDefines: <\nassuming: 'F is \\field'\nmeans:\n. '< is \\binary.operation:on{X}'\n. '< is \\transitive.relation:on{X}'\n. for: a, b\n  where: 'a, b \\in X'\n  then:\n  . or:\n    . 'a = b'\n    . 'a < b'\n    . 'b < a'\n. for: a, b, c\n  where: 'a, b, c \\in X'\n  then:\n  . if: 'a < b'\n    then: 'a + c < b + c'\n. for: a, b, c\n  where:\n  . 'a, b, c \\in X'\n  . '0 < c'\n  then:\n  . if: 'a < b'\n    then: 'a * c < b * c'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["order", "relation", "on", "f", "=", "x", "+", "*", "0", "1", "<", "is", "field", "binary", "operation", "transitive", "a", "b", "in", "c", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[\\ordered.field]\nDefines: (X, +, *, 0, 1, <)\nmeans:\n. for: F\n  where: 'F := (X, +, *, 0, 1)'\n  then:\n  . 'F is \\field'\n  . '< is \\order.relation:on{F}'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["ordered", "field", "x", "+", "*", "0", "1", "<", "f", "=", "is", "order", "relation", "on", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[\\real.field]\nDefines: R := (X, +, *, 0, 1, <)\nmeans: 'R is \\ordered.field'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["real", "field", "r", "=", "x", "+", "*", "0", "1", "<", "is", "ordered", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[\\reals]\nDefines: R\nmeans:\n. for: Rb := (X, +, *, 0, 1, <)\n  where: 'Rb is \\real.field'\n  then: 'R := X'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["reals", "r", "rb", "=", "x", "+", "*", "0", "1", "<", "is", "real", "field", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[\\real]\nDefines: r\nmeans: 'r \\in \\reals'",
  "keywords": ["real", "r", "in", "reals"],
  "href": "null",
  "mobileHref": "null",
},
{
  "text": "[\\real.order]\nDefines: op\nmeans:\n. for: R := (X, +, *, 0, 1, <)\n  where: 'R is \\real.field'\n  then: 'op := <'",
  "keywords": ["real", "order", "op", "r", "=", "x", "+", "*", "0", "1", "<", "is", "field"],
  "href": "null",
  "mobileHref": "null",
},
{
  "text": "[a < b]\nDefines: <\nmeans:\n. if:\n  . 'a, b is \\real'\n  then:\n  . '< := \\real.order'",
  "keywords": ["a", "<", "b", "is", "real", "=", "order"],
  "href": "null",
  "mobileHref": "null",
},
{
  "text": "[a \\lt b]\nDefines: lt\nmeans: 'lt := <'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["a", "lt", "b", "=", "<", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[a > b]\nDefines: >\nmeans: 'b < a'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["a", ">", "b", "<", "reference", "=", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
  "text": "[a \\gt b]\nDefines: gt\nmeans: 'gt := >'\nMetadata:\n. reference = \"source: @TrenchRealAnalysis; page: 2\"",
  "keywords": ["a", "gt", "b", "=", ">", "reference", "source", "trenchrealanalysis", "page", "2"],
  "href": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page=11",
  "mobileHref": "https://digitalcommons.trinity.edu/cgi/viewcontent.cgi?article=1006&context=mono#page11",
},
{
