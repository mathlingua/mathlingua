...
var ProofNoteBySections = []string{
	LowerNoteName,
	LowerByName,
}

type ProofNoteByGroup struct {
	Label          *GroupLabel
...
var ProofNoteBecauseSections = []string{
	LowerNoteName,
	LowerBecauseName,
}

type ProofNoteBecauseGroup struct {
	Label          *GroupLabel
	Note           ProofNoteSection
