...
func (FunctionTypeForm) TypeForm() {}
func (TupleTypeForm) TypeForm()    {}
func (SetTypeForm) TypeForm()      {}

type FunctionTypeForm struct {
	Inputs []ResolvedType
	Output ResolvedType
}

type TupleTypeForm struct {
	Items []ResolvedType
}

type SetTypeForm struct {
	Target ResolvedType
}
