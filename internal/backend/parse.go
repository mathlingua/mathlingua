...
func ParseDocument(text string, path ast.Path, tracker frontend.DiagnosticTrackerType) ast.Document {
...
func ParseRoot(texts map[ast.Path]string, tracker frontend.DiagnosticTrackerType) ast.Root {
