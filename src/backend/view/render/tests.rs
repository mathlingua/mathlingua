...
"#,
    ...
    assert_eq!(
        render_group_heading_latex("Declares", Some(heading), None, &registry),
        Some(r#"H \leq G"#.to_string())
    );
    assert_eq!(
        render_group_parameter_destructurings("Declares", Some(heading), &registry),
        vec![
...
"#,
    ...
    assert_eq!(
        render_group_heading_latex("Declares", Some(r#"A \:subset:/ B"#), None, &registry),
...
"#,
    ...
    assert_eq!(
        render_group_heading_latex("Declares", Some(r#"\set"#), None, &registry),
