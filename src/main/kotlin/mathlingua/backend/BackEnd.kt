...
internal object BackEnd {
    fun check(sourceCollection: SourceCollection): List<ValueSourceTracker<ParseError>> {
        ...
        errors.addAll(sourceCollection.getColonEqualsRhsErrors())
        errors.addAll(sourceCollection.getInputOutputSymbolErrors())
        errors.addAll(sourceCollection.getNonExpressesUsedInNonIsNonInStatementsErrors())
        return errors
    }
