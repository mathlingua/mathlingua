...
fun neoValidateMappingSection(node: Phase1Node, errors: MutableList<ParseError>) =
    neoValidateSection(node, errors, "mapping", DEFAULT_MAPPING_SECTION) {
        MappingSection()
    }
