...
import mathlingua.chalktalk.phase2.ast.DEFAULT_DEFINES_MAPS_GROUP
...
fun neoValidateDefinesMapsGroup(
    node: Phase1Node, errors: MutableList<ParseError>, tracker: MutableLocationTracker
) =
    neoTrack(node, tracker) {
        neoValidateGroup(node.resolve(), errors, "Defines", DEFAULT_DEFINES_MAPS_GROUP) { group ->
            neoIdentifySections(
                group,
                errors,
                ...
                DefinesMapsGroup(
                    ...
                    mapsSection =
                        neoEnsureNonNull(sections["maps"], DEFAULT_MAPS_SECTION) {
                            neoValidateMapsSection(it, errors, tracker)
                        },
                    usingSection =
