...
fun neoValidateSingleFromSection(node: Phase1Node, errors: MutableList<ParseError>) =
    neoValidateSection(node, errors, "from", DEFAULT_SINGLE_FROM_SECTION) {
        SingleFromSection(
            statement = neoValidateStatement(it, errors)
        )
    }
