...
import mathlingua.common.chalktalk.phase2.findNode
...
class MathLingua {
    ...
    fun expandAtPosition(text: String, row: Int, column: Int): Validation<Document> {
        return when (val validation = parse(text)) {
            ...
            is ValidationSuccess -> {
                ...
                val newDoc = expandAtNode(doc, target)
