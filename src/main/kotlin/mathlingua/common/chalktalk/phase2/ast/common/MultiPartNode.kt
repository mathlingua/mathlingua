...
package mathlingua.common.chalktalk.phase2.ast.common
...
abstract class MultiPartNode(
    ...
    override fun toCode(isArg: Boolean, indent: Int, writer: CodeWriter) =
        mathlingua.common.chalktalk.phase2.ast.clause.toCode(writer, isArg, indent, *sections.toTypedArray())
...
abstract class ZeroPartNode(val node: Phase1Node) : Phase2Node {
    ...
    override fun toCode(isArg: Boolean, indent: Int, writer: CodeWriter) =
        mathlingua.common.chalktalk.phase2.ast.clause.toCode(writer, isArg, indent, node)
