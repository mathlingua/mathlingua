...
fun isNoteGroup(groupNode: Group) = firstSectionMatchesName(groupNode, "Note")

fun validateNoteGroup(groupNode: Group, tracker: MutableLocationTracker) =
    validateProtoGroup(groupNode, "Note", tracker, ::NoteGroup)
