...
fun isProblemGroup(groupNode: Group) = firstSectionMatchesName(groupNode, "Problem")

fun validateProblemGroup(groupNode: Group, tracker: MutableLocationTracker) =
    validateProtoGroup(groupNode, "Problem", tracker, ::ProblemGroup)
