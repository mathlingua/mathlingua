...
internal val DEFAULT_WITH_SECTION = WithSection(targets = listOf(), row = -1, column = -1)
...
internal val DEFAULT_MATCHING_SECTION =
    MatchingSection(clauses = DEFAULT_CLAUSE_LIST_NODE, row = -1, column = -1)

internal val DEFAULT_MATCHING_GROUP =
    MatchingGroup(matchingSection = DEFAULT_MATCHING_SECTION, row = -1, column = -1)
