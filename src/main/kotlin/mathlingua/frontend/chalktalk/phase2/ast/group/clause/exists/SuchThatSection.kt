...
internal data class SuchThatSection(
...
internal fun validateSuchThatSection(node: Phase1Node, errors: MutableList<ParseError>) =
    validateSection(node.resolve(), errors, "suchThat", DEFAULT_SUCH_THAT_SECTION) {
        SuchThatSection(clauses = validateClauseListNode(it, errors), node.row, node.column)
    }
