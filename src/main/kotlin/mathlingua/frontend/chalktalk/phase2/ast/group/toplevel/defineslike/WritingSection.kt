...
import mathlingua.frontend.chalktalk.phase2.ast.DEFAULT_WRITING_SECTION
import mathlingua.frontend.chalktalk.phase2.ast.common.Phase2Node
import mathlingua.frontend.chalktalk.phase2.ast.validateSection
import mathlingua.frontend.support.ParseError

internal data class WritingSection(
...
internal fun isWritingSection(sec: Section) = sec.name.text == "writing"

internal fun validateWritingSection(node: Phase1Node, errors: MutableList<ParseError>) =
    validateSection(node.resolve(), errors, "writing", DEFAULT_WRITING_SECTION) { section ->
