...
internal data class ViewSection(override val row: Int, override val column: Int) : Phase2Node {
...
internal fun validateViewSection(node: Phase1Node, errors: MutableList<ParseError>) =
    validateSection(node.resolve(), errors, "view", DEFAULT_VIEW_SECTION) {
        ViewSection(node.row, node.column)
    }
