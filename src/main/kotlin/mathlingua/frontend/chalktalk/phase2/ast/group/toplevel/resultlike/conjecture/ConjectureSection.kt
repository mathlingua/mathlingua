...
internal data class ConjectureSection(
...
internal fun validateConjectureSection(node: Phase1Node, errors: MutableList<ParseError>) =
    validateSection(node.resolve(), errors, "Conjecture", DEFAULT_CONJECTURE_SECTION) { section ->
