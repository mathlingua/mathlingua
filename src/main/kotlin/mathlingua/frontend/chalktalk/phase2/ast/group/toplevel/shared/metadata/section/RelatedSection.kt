...
internal data class RelatedSection(
    ...
    override fun transform(chalkTransformer: (node: Phase2Node) -> Phase2Node) =
        chalkTransformer(
            RelatedSection(items = items.map { chalkTransformer(it) as StringItem }, row, column))
}

internal fun validateRelatedSection(node: Phase1Node, errors: MutableList<ParseError>) =
