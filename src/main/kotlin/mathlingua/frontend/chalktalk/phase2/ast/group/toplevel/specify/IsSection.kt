...
internal data class IsSection(val statement: Statement) : Phase2Node {
    ...
    override fun transform(chalkTransformer: (node: Phase2Node) -> Phase2Node) =
        chalkTransformer(IsSection(statement = statement.transform(chalkTransformer) as Statement))
}

internal fun validateIsSection(
