...
internal data class AndGroup(val andSection: AndSection, override val metadata: MetaData) : Group(metadata), Clause

internal data class NotSection(val clause: Clause, override val metadata: MetaData) : Section("not", metadata)

internal data class NotGroup(val notSection: NotSection, override val metadata: MetaData) : Group(metadata), Clause

internal data class OrSection(val clauses: List<Clause>, override val metadata: MetaData) : Section("or", metadata)

internal data class OrGroup(val orSection: OrSection, override val metadata: MetaData) : Group(metadata), Clause
...
internal data class ExistsGroup(
    ...
    val suchThatSection: SuchThatSection?, override val metadata: MetaData) : Group(metadata), Clause
...
internal data class ForAllGroup(
    ...
    val thenSection: ThenSection, override val metadata: MetaData) : Group(metadata), Clause
...
internal data class GeneratedGroup(
    ...
    override val metadata: MetaData) : Group(metadata), SatisfyingItem
...
internal data class EqualityGroup(
    ...
    override val metadata: MetaData) : Group(metadata), ProvidingItem
...
internal data class DefinesGroup(
    ...
    override val metadata: MetaData) : Group(metadata), TopLevelGroup
...
internal data class ThatSection(val items: List<ThatItem>, override val metadata: MetaData) : Section("that", metadata)
...
internal data class SpecifyGroup(
    val specifySection: SpecifySection,
    override val metadata: MetaData) : Group(metadata), TopLevelGroup
...
internal data class ZeroGroup(
    ...
    override val metadata: MetaData) : Group(metadata), SpecifyItem
