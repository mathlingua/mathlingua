...
private data class TestCase(val input: String, val expectedType: TokenType, val expectedText: String)

private const val PREFIX = "abc_123 \"prefix text\" `prefix stmt 1` 'prefix stmt 2'123*+:=" +
...
private val INDENT_UN_INDENT_TEST_INPUT = """
            ...
            fifthHeader:
        """.trimIndent()
private val INDENT_UN_INDENT_EXPECTED = listOf(
